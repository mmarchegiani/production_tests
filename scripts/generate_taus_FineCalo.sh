#!/bin/bash
#
# Full taus production chain: [MINBIAS] -> GSD -> RECO -> nanoML -> parquet.
...
# PU mixing wiring) -- see generate_taus_noFineCalo.sh for PU samples.
#
# Usage:   bash generate_taus_FineCalo.sh <output_directory> [n_events] [options]
# Example: bash generate_taus_FineCalo.sh /path/to/output/folder 1000
